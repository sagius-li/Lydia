...
{
    public class GenericResultEnumerator : IEnumerator<RmGeneric>, IEnumerable<RmGeneric>
    {
        ...
        private List<RmGeneric> results;
        private int resultIndex;
        private bool endOfSequence;
        private EnumerationContext context;
        private string filter;
        private string[] attributes;
        private RmGeneric current;

        #endregion

        #region Constructor

        public GenericResultEnumerator(WSEnumerationClient client, RequestFactory requestFactory, ResponseFactory responseFactory, 
            RmResourceFactory resourceFactory, string filter, string[] attributes)
        {
            this.results = new List<RmGeneric>();
        ...
        public IEnumerator<RmGeneric> GetEnumerator()
        {
            return this;
        }
